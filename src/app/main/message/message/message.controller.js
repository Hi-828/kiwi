(function ()
{
  ...
  /** @ngInject */
  function MessageController($scope,BendAuth, BendService, CommonUtil, $mdMedia, $mdDialog, $rootScope, $location, $bend, $timeout)
  {
    BendAuth.checkAuth();
    ...
    var userId = BendAuth.getActiveUser()._id;
    var lastTime = 0;
    ...
    if($scope.user.avatar) {
      BendService.getFile($scope.user.avatar, function(ret){
        $scope.user.avatar = ret;
      });
    }
